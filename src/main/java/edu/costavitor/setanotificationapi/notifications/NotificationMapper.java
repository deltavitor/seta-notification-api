...
public interface NotificationMapper {
    ...
    @Mapping(target = "codigoUnidadeNotificacao", expression = "java(source.getCoUnidadeNotificacao().isEmpty() ? null : Integer.parseInt(source.getCoUnidadeNotificacao()))")
    ...
    @Mapping(target = "codigoBairroResidencia", expression = "java(source.getCoBairroResidencia().isEmpty() ? null : Integer.parseInt(source.getCoBairroResidencia()))")
    @Mapping(target = "bairroResidencia", source = "noBairroResidencia")
    @Mapping(target = "codigoLogradouroResidencia", expression = "java(source.getCoLogradouroResidencia().isEmpty() ? null : Integer.parseInt(source.getCoLogradouroResidencia()))")
